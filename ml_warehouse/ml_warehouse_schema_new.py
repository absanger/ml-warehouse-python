...
class CgapBiomaterial(Base):
    ...
    biomaterial_uuid = Column(
        String(36, "utf8_unicode_ci"), nullable=False, unique=True
    )
...
class CgapConjuredLabware(Base):
    ...
    cgap_conjured_labware_tmp = Column(
        INTEGER(10),
        primary_key=True,
        comment="Internal to this database id. Value can change.",
    )
    barcode = Column(String(32, "utf8_unicode_ci"), nullable=False, index=True)
    cell_line_long_name = Column(
        String(48, "utf8_unicode_ci"), nullable=False, index=True
    )
...
class CgapHeron(Base):
    ...
    supplier_sample_id = Column(
        String(64, "utf8_unicode_ci"), nullable=False, index=True
    )
    ...
    sample_identifier = Column(
        String(64, "utf8_unicode_ci"),
        index=True,
...
class CgapLineIdentifier(Base):
    ...
    cgap_line_identifier_tmp = Column(
        INTEGER(10),
        primary_key=True,
        comment="Internal to this database id. Value can change.",
    )
...
class CgapOrganoidsConjuredLabware(Base):
    ...
    cgap_organoids_conjured_labware_tmp = Column(
        INTEGER(10),
        primary_key=True,
        comment="Internal to this database id. Value can change.",
    )
...
class CgapSupplierBarcode(Base):
    ...
    cgap_supplier_barcode_tmp = Column(
        INTEGER(10),
        primary_key=True,
        comment="Internal to this database id. Value can change.",
    )
    biomaterial_uuid = Column(String(36, "utf8_unicode_ci"), nullable=False, index=True)
    supplier_barcode = Column(
        String(20, "utf8_unicode_ci"), nullable=False, unique=True
    )
    date = Column(
        TIMESTAMP, nullable=False, server_default=text("'0000-00-00 00:00:00'")
    )
...
class IseqExternalProductMetric(Base):
    ...
    id_iseq_ext_pr_metrics_tmp = Column(
        BIGINT(20),
        primary_key=True,
        comment="Internal to this database id, value can change",
    )
    ...
    supplier_sample_name = Column(
        VARCHAR(255),
        index=True,
        comment="Sample name given by the supplier, as recorded by WSI",
    )
    plate_barcode = Column(
        VARCHAR(255), index=True, comment="Stock plate barcode, as recorded by WSI"
    )
    ...
    adapter_contamination_assessment = Column(
        String(255),
    ...
    basic_statistics_assessement = Column(
        String(255),
    ...
    overrepresented_sequences_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    n_content_per_base_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    sequence_content_per_base_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    sequence_quality_per_base_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    gc_content_per_sequence_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    quality_scores_per_sequence_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    sequence_duplication_levels_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
    sequence_length_distribution_assessement = Column(
        String(255),
        comment='FastQC "PASS", "WARN", "FAIL" per input file. Array of strings separated by "/", with a "," separating entries for paired-end 1 and 2 reads. e.g. Four RG "PASS/PASS/WARN/PASS,PASS/PASS/WARN/PASS"',
    )
...
class IseqHeronProductMetric(Base):
    ...
    id_iseq_hrpr_metrics_tmp = Column(
        BIGINT(20),
        primary_key=True,
        comment="Internal to this database id, value can change",
    )
    ...
    id_iseq_product = Column(
        CHAR(64, "utf8_unicode_ci"),
        nullable=False,
        unique=True,
    ...
    artic_qc_outcome = Column(
        CHAR(15, "utf8_unicode_ci"),
    ...
    cog_sample_meta = Column(
        TINYINT(1), comment="A Boolean flag to mark sample metadata upload to COG"
    )
    path_root = Column(
        String(255, "utf8_unicode_ci"),
    ...
    longest_no_N_run = Column(
        SMALLINT(5), comment="Longest consensus data stretch without N"
    )
    ivar_amd = Column(
        SMALLINT(5),
        comment="ivar minimum depth used in generating the additional consensus",
    )
    pct_N_bases_amd = Column(
        Float, comment="Percent of N bases in the additional consensus"
    )
    longest_no_N_run_amd = Column(
        SMALLINT(5),
...
class IseqRun(Base):
    ...
    id_flowcell_lims = Column(
        String(20, "utf8_unicode_ci"), index=True, comment="LIMS specific flowcell id"
    )
...
class IseqRunLaneMetric(Base):
    ...
    position = Column(
        SMALLINT(2), primary_key=True, nullable=False, comment="Flowcell lane number"
    )
    last_changed = Column(
        DateTime,
        server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
    ...
    instrument_external_name = Column(
        CHAR(10, "utf8_unicode_ci"),
        comment="Name assigned to the instrument by the manufacturer",
    )
    instrument_model = Column(CHAR(64, "utf8_unicode_ci"))
    instrument_side = Column(
        CHAR(1, "utf8_unicode_ci"),
        comment="Illumina instrument side (A or B), if appropriate",
    )
    workflow_type = Column(
        String(20, "utf8_unicode_ci"), comment="Illumina instrument workflow type"
    )
    ...
    unexpected_tags_percent = Column(
        Float(5), comment="tag0_perfect_match_reads as a percentage of total_lane_reads"
    )
    tag_hops_percent = Column(Float, comment="Percentage tag hops for dual index runs")
    tag_hops_power = Column(
...
class LighthouseSample(Base):
    ...
    mongodb_id = Column(
        String(255, "utf8_unicode_ci"),
        unique=True,
        comment="Auto-generated id from MongoDB",
    )
    root_sample_id = Column(
        String(255, "utf8_unicode_ci"),
        nullable=False,
    ...
    cog_uk_id = Column(
        String(255, "utf8_unicode_ci"),
        index=True,
        comment="Consortium-wide id, generated by Sanger on import to LIMS",
    )
    rna_id = Column(
        String(255, "utf8_unicode_ci"),
        nullable=False,
    ...
    date_tested_string = Column(
        String(255, "utf8_unicode_ci"),
        comment="When the covid-19 test was carried out by the Lighthouse lab",
    )
    date_tested = Column(
        DateTime, index=True, comment="date_tested_string in date format"
    )
    source = Column(
        String(255, "utf8_unicode_ci"),
    ...
    filtered_positive = Column(
        TINYINT(1), index=True, comment="Filtered positive result value"
    )
    filtered_positive_version = Column(
        String(255, "utf8_unicode_ci"), comment="Filtered positive version"
    )
    filtered_positive_timestamp = Column(
        DateTime, comment="Filtered positive timestamp"
    )
    lh_sample_uuid = Column(
        String(36, "utf8_unicode_ci"),
        unique=True,
        comment="Sample uuid created in crawler",
    )
    lh_source_plate_uuid = Column(
        String(36, "utf8_unicode_ci"), comment="Source plate uuid created in crawler"
    )
...
class PacBioRunWellMetric(Base):
    ...
    control_read_length_mean = Column(
        INTEGER(10), comment="The mean polymerase read length of the control reads"
    )
    ...
    polymerase_read_length_mean = Column(
        INTEGER(10), comment="The mean high-quality read length of all polymerase reads"
    )
    ...
    unique_molecular_bases = Column(
        BIGINT(20), comment="The unique molecular yield in bp"
    )
    productive_zmws_num = Column(INTEGER(10), comment="Number of productive ZMWs")
    p0_num = Column(
        INTEGER(10), comment="Number of empty ZMWs with no high quality read detected"
    )
    p1_num = Column(
        INTEGER(10), comment="Number of ZMWs with a high quality read detected"
    )
    p2_num = Column(
        INTEGER(10),
    ...
    hifi_read_quality_median = Column(
        SMALLINT(5), comment="The median HiFi base quality"
    )
    hifi_number_passes_mean = Column(
        INTEGER(10), comment="The mean number of passes per HiFi read"
    )
...
class Sample(Base):
    ...
    developmental_stage = Column(
        String(255, "utf8_unicode_ci"), comment="Developmental Stage"
    )
...
class BmapFlowcell(Base):
    ...
    id_flowcell_lims = Column(
        String(255), nullable=False, index=True, comment="LIMs-specific flowcell id"
    )
    id_library_lims = Column(
        String(255),
        index=True,
...
class FlgenPlate(Base):
    ...
    plate_barcode = Column(
        INTEGER(10), nullable=False, comment="Manufacturer (Fluidigm) chip barcode"
    )
    plate_barcode_lims = Column(
        String(128, "utf8_unicode_ci"), comment="LIMs-specific plate barcode"
    )
    plate_uuid_lims = Column(
        String(36, "utf8_unicode_ci"), comment="LIMs-specific plate uuid"
    )
    id_flgen_plate_lims = Column(
        String(20, "utf8_unicode_ci"), nullable=False, comment="LIMs-specific plate id"
    )
    plate_size = Column(SMALLINT(6), comment="Total number of wells on a plate")
    plate_size_occupied = Column(
        SMALLINT(6), comment="Number of occupied wells on a plate"
    )
    well_label = Column(
        String(10, "utf8_unicode_ci"),
        nullable=False,
    ...
    well_uuid_lims = Column(
        String(36, "utf8_unicode_ci"), comment="LIMs-specific well uuid"
    )
    qc_state = Column(
...
class IseqExternalProductComponent(Base):
    ...
    id_iseq_ext_pr_components_tmp = Column(
        BIGINT(20),
        primary_key=True,
        comment="Internal to this database id, value can change",
    )
    id_iseq_product_ext = Column(
        ForeignKey("iseq_external_product_metrics.id_iseq_product"),
        nullable=False,
        index=True,
...
class IseqFlowcell(Base):
    ...
    entity_type = Column(
        ...
        nullable=False,
        comment="Lane type: library, pool, library_control, library_indexed, library_indexed_spike",
    )
    entity_id_lims = Column(
        String(20, "utf8_unicode_ci"),
        nullable=False,
    ...
    tag_set_id_lims = Column(
        String(20, "utf8_unicode_ci"), comment="LIMs-specific identifier of the tag set"
    )
    tag_set_name = Column(
        String(100, "utf8_unicode_ci"), comment="WTSI-wide tag set name"
    )
    tag_identifier = Column(
        String(30, "utf8_unicode_ci"),
        comment="The position of tag within the tag group",
    )
    tag2_sequence = Column(
        String(30, "utf8_unicode_ci"), comment="Tag sequence for tag 2"
    )
    tag2_set_id_lims = Column(
        String(20, "utf8_unicode_ci"),
        comment="LIMs-specific identifier of the tag set for tag 2",
    )
    tag2_set_name = Column(
        String(100, "utf8_unicode_ci"), comment="WTSI-wide tag set name for tag 2"
    )
    tag2_identifier = Column(
        String(30, "utf8_unicode_ci"),
    ...
    bait_name = Column(
        String(50, "utf8_unicode_ci"),
        comment="WTSI-wide name that uniquely identifies a bait set",
    )
    requested_insert_size_from = Column(
        INTEGER(5), comment="Requested insert size min value"
    )
    requested_insert_size_to = Column(
        INTEGER(5), comment="Requested insert size max value"
    )
    forward_read_length = Column(
        SMALLINT(4), comment="Requested forward read length, bp"
    )
    reverse_read_length = Column(
        SMALLINT(4), comment="Requested reverse read length, bp"
    )
    id_pool_lims = Column(
        String(20, "utf8_unicode_ci"),
        nullable=False,
    ...
    legacy_library_id = Column(
        INTEGER(11),
        index=True,
        comment="Legacy library_id for backwards compatibility.",
    )
    id_library_lims = Column(
        String(255, "utf8_unicode_ci"),
        index=True,
...
class IseqRunStatu(Base):
    ...
    id_run = Column(
        INTEGER(10), nullable=False, index=True, comment="NPG run identifier"
    )
    date = Column(DateTime, nullable=False, comment="Status timestamp")
    id_run_status_dict = Column(
        ForeignKey("iseq_run_status_dict.id_run_status_dict"),
        nullable=False,
        index=True,
...
class OseqFlowcell(Base):
    ...
    tag_sequence = Column(
        String(255, "utf8_unicode_ci"), comment="Sequence of the first tag"
    )
    tag_set_id_lims = Column(
        String(255, "utf8_unicode_ci"),
    ...
    tag2_sequence = Column(
        String(255, "utf8_unicode_ci"), comment="Sequence of the second tag"
    )
    tag2_set_id_lims = Column(
        String(255, "utf8_unicode_ci"),
...
class PacBioRun(Base):
    ...
    pac_bio_library_tube_legacy_id = Column(
        INTEGER(11), comment="Legacy library_id for backwards compatibility."
    )
...
class StockResource(Base):
    ...
    id_stock_resource_lims = Column(
        String(20, "utf8_unicode_ci"),
        nullable=False,
        comment="Lims specific identifier for the stock",
    )
    stock_resource_uuid = Column(
        String(36, "utf8_unicode_ci"), comment="Uuid identifier for the stock"
    )
    labware_type = Column(
        String(255, "utf8_unicode_ci"),
        nullable=False,
    ...
    snp_count = Column(
        INTEGER(11), comment="The number of markers detected in genotyping assays"
    )
    measured_gender = Column(
        String(255, "utf8_unicode_ci"),
...
class TolSampleBioproject(Base):
    ...
    id_sample_tmp = Column(
        ForeignKey("sample.id_sample_tmp", ondelete="SET NULL"), index=True
    )
...
class IseqProductMetric(Base):
    ...
    id_iseq_pr_metrics_tmp = Column(
        BIGINT(20),
        primary_key=True,
        comment="Internal to this database id, value can change",
    )
    id_iseq_product = Column(
        CHAR(64, "utf8_unicode_ci"), nullable=False, unique=True, comment="Product id"
    )
    last_changed = Column(
        DateTime,
        server_default=text("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP"),
    ...
    tag_sequence4deplexing = Column(
        String(30, "utf8_unicode_ci"),
        comment="Tag sequence used for deplexing the lane, common suffix might have been truncated",
    )
    actual_forward_read_length = Column(
        SMALLINT(4), comment="Actual forward read length, bp"
    )
    actual_reverse_read_length = Column(
        SMALLINT(4), comment="Actual reverse read length, bp"
    )
    ...
    chimeric_reads_percent = Column(
        Float(5), comment="mate_mapped_defferent_chr_5 as percentage of all"
    )
    ...
    rna_genes_detected = Column(
        INTEGER(10), comment="Number of genes detected with at least 5 reads."
    )
    rna_norm_3_prime_coverage = Column(
        Float,
    ...
    rna_norm_5_prime_coverage = Column(
        Float,
    ...
    target_mapped_reads = Column(
        BIGINT(20), comment="The number of mapped reads passing the target filter"
    )
    target_proper_pair_mapped_reads = Column(
        BIGINT(20),
        comment="The number of proper pair mapped reads passing the target filter",
    )
    target_mapped_bases = Column(
        BIGINT(20), comment="The number of mapped bases passing the target filter"
    )
    target_coverage_threshold = Column(
        INTEGER(4),
        comment="The coverage threshold used in the target perc target greater than depth calculation",
    )
    target_percent_gt_coverage_threshold = Column(
        Float(5),
    ...
    target_autosome_percent_gt_coverage_threshold = Column(
        Float(5),
...
class IseqProductAmpliconstat(Base):
    ...
    id_iseq_product = Column(
        ForeignKey("iseq_product_metrics.id_iseq_product"),
        nullable=False,
        comment="Product id, a foreign key into iseq_product_metrics table",
    )
    primer_panel = Column(
    ...
    primer_panel_num_amplicons = Column(
        SMALLINT(5),
        nullable=False,
        comment="Total number of amplicons in the primer panel",
    )
    amplicon_index = Column(
        SMALLINT(5),
        nullable=False,
...
class IseqProductComponent(Base):
    ...
    id_iseq_pr_components_tmp = Column(
        BIGINT(20),
        primary_key=True,
        comment="Internal to this database id, value can change",
    )
    id_iseq_pr_tmp = Column(
        ForeignKey("iseq_product_metrics.id_iseq_pr_metrics_tmp", ondelete="CASCADE"),
        nullable=False,
        comment="iseq_product_metrics table row id for the product",
    )
    id_iseq_pr_component_tmp = Column(
        ForeignKey("iseq_product_metrics.id_iseq_pr_metrics_tmp"),
        nullable=False,
        index=True,
    ...
    iseq_product_metric = relationship(
        "IseqProductMetric",
        primaryjoin="IseqProductComponent.id_iseq_pr_component_tmp == IseqProductMetric.id_iseq_pr_metrics_tmp",
    )
    iseq_product_metric1 = relationship(
        "IseqProductMetric",
        primaryjoin="IseqProductComponent.id_iseq_pr_tmp == IseqProductMetric.id_iseq_pr_metrics_tmp",
    )
